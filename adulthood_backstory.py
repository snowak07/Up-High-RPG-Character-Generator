...
class AdulthoodBackstory:
    ...
    def addEvent(self, event: 'AdulthoodBackstoryEvent', index: int = None):
...
class AdulthoodBackstoryEvent:
    def __init__(self, profession = "", scenario = "", tested_ability = "", influenced_ability = "", learned_skill = ""):
    ...
    def tested_ability(self, value: str):
        if not isinstance(value, str) or not value.strip():
    ...
    def influenced_ability(self, value: str):
        if not isinstance(value, str) or not value.strip():
